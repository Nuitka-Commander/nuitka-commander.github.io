    ...
    nav_bar: { // Navigation bar
        mode: {
            ...
            info: {
                ...
                l3: "Complex mode: Display all available options",
            },
            show_raw_command: "Show raw command",
            no_show_raw_command: "Hide raw command",
            show_raw_command_info: "Whether to display the raw command in the command settings",
        },
