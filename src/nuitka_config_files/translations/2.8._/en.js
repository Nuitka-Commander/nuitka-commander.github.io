...
export default {
    ...
    recompile_extension_modules: {
        name: "Recompile Extension Modules",
        desc: "Force recompilation of extension modules from source code. Allows fine-grained control over which extension modules to recompile using name patterns.\nUseful when you want to ensure certain modules are compiled from source for better optimization. Can be given multiple times. Default is empty.",
    },
    ...
    debugger_choice: {
        name: "Debugger Choice",
        desc: "Choose a specific debugger to use with the --debugger option. This allows you to specify arbitrary debuggers instead of relying on automatic detection.\nFor example: gdb, lldb, or any custom debugger. Default is automatic selection.",
    },
    // Compilation choices
    ...
    macos_sign_keyring_filename: {
        name: "macOS Keyring Filename",
        desc: "Specify the keyring filename for automated code signing in CI/CD environments. This allows signing without UI prompts by providing the keyring file directly.\nUseful for automated build pipelines. Default is empty.",
    },
    macos_sign_keyring_password: {
        name: "macOS Keyring Password",
        desc: "Specify the password for the keyring file used in automated code signing. Works in conjunction with --macos-sign-keyring-filename to enable non-interactive signing in CI/CD workflows.\nDefault is empty.",
    },
    macos_app_version: {
