...
const config = {
    ...
    basic: {
        ...
        mode: add_option.single_option(
            ...
            true,
            {
                accelerated: add_option.multi_elements(
                    "accelerated",
                    {
                ...
                standalone: add_option.multi_elements(
                    "standalone",
                    {
                        original: "standalone",
                    },
                ...
                onefile: add_option.multi_elements(
                    "onefile",
                    {
                        original: "onefile",
                    },
    ...
    control_the_inclusion_of_modules_and_packages_in_result: {
        ...
        recompile_extension_modules: add_option.definable_multi(
            "recompile_extension_modules",
            {
                original: "--recompile-extension-modules",
            },
            true,
            {},
            [],
    ...
    onefile_options: {
        ...
        onefile_cache_mode: add_option.single_option(
            "onefile_cache_mode",
            {
                original: "--onefile-cache-mode",
            },
            true,
            {
                ...
                temporary: add_option.multi_elements(
                    "temporary",
                    {
                        original: "temporary",
                    },
                ...
                cached: add_option.multi_elements(
                    "cached",
                    {
                        original: "cached",
                    },
        ...
        onefile_no_dll: add_option.bool(
            "onefile_no_dll",
            {
                original: "--onefile-no-dll",
            },
            true,
            false,
        ),
    ...
    metadata_support: {
        ...
        list_distribution_metadata: add_option.bool(
            "list_distribution_metadata",
            {
                original: "--list-distribution-metadata",
            },
            true,
            false,
        ),
    ...
    DLL_files: {
        ...
        list_package_exe: add_option.definable_multi(
            "list_package_exe",
            {
                original: "--list-package-exe",
            },
            true,
            {},
            [],
    ...
    immediate_execution_after_compilation: {
        ...
        debugger_choice: add_option.definable_single(
            "debugger_choice",
            {
                original: "--debugger-choice",
            },
            true,
            {},
            "",
    ...
    output_choices: {
        ...
        no_pyi_stubs: add_option.bool(
            "no_pyi_stubs",
            {
                original: "--no-pyi-stubs",
            },
            true,
            false,
        ),
    ...
    debug_features: {
        ...
        no_debug_c_warnings: add_option.bool(
            "no_debug_c_warnings",
            {
                original: "--no-debug-c-warnings",
            },
            true,
            false,
        ),
    ...
    nuitka_development_features: {
        devel_missing_code_helpers: add_option.bool(
            "devel_missing_code_helpers",
            {
                original: "--devel-missing-code-helpers",
            },
            true,
            false,
        ),
        devel_missing_trust: add_option.bool(
            "devel_missing_trust",
            {
                original: "--devel-missing-trust",
            },
            true,
            false,
        ),
        devel_recompile_c_only: add_option.bool(
            "devel_recompile_c_only",
            {
                original: "--devel-recompile-c-only",
            },
            true,
            false,
        ),
        devel_internal_graph: add_option.bool(
            "devel_internal_graph",
            {
                original: "--devel-internal-graph",
            },
            true,
            false,
        ),
    ...
    macOS_specific_controls: {
        ...
        macos_sign_keyring_filename: add_option.definable_single(
            "macos_sign_keyring_filename",
            {
                original: "--macos-sign-keyring-filename",
            },
            true,
            {},
            "",
        ...
        macos_sign_keyring_password: add_option.definable_single(
            "macos_sign_keyring_password",
            {
                original: "--macos-sign-keyring-password",
            },
            true,
            {},
            "",
    ...
    plugin_options_of_playwright: {
        playwright_include_browser: add_option.definable_multi(
            "playwright_include_browser",
            {
                original: "--playwright-include-browser",
            },
            true,
            {
                all: add_option.multi_elements(
        ...
        return add_watcher(
            {
                ...
                // 在 2.8 版本中，独立模式下可以使用输出文件名
                // 只有在模块模式下才禁用输出文件名
                if (config.module.val === true) {
